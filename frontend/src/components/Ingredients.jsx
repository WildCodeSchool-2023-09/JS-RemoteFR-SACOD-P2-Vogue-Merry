...
function Ingredients({
  ...
  return (
    <button
      type="button"
      className="flex bg-purple-heart-500 rounded disabled:bg-purple-heart-900 text-white font-irish w-full h-full justify-center items-center max-sm:text-sm "
      onClick={() => {
        isTrue();
        handleClick();
      }}
